...
\]
\textbf{plantee} la integral como una integral iterada en las variables $u$ y $v$ (no es necesario evaluarla).
...
\]
\textbf{Plantee} la integral triple
\[
    \iiint_R xy\,dV
\]
...
\]
\textbf{Plantee} la integral de línea
\[
    \int_C f\,ds
\]
